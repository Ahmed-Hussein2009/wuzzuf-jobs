...
//----------------------------------Job count------------------------------------
    ...
    @RequestMapping("/show-pieChart")
    public ResponseEntity<String> display_image() {
        return ResponseEntity.ok("<img src=\"PPieChart.png\" />");
    }
    ...
    @RequestMapping("Count-All-Title")
    ...
    @Autowired
    public BRCHrt bartitle_chart() throws IOException {
    ...
    @Autowired
    public BRCHrt bararea_chart() throws IOException {
